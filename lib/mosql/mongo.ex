defmodule Mosql.Mongo do
  ...
  @doc """
  Returns the child spec based on the given opts
  """
  def child_spec(mongo_opts) do
    mongo_opts = Keyword.merge(mongo_opts, backoff_type: :stop)
    %{id: Mongo, start: {Mongo, :start_link, [mongo_opts]}, restart: :transient}
  end
