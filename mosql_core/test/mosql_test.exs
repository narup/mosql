defmodule MosqlTest do
  ...
  test "test schema load", %{store: schema_store} do
    case Schema.load_collection("users", "test/fixtures") do
      {:ok, schema} ->
  ...
  test "test schema load nested keys", %{store: schema_store} do
    case Schema.load_collection("profiles", "test/fixtures") do
      {:ok, schema} ->
  ...
  test "test sql type values", %{store: schema_store} do
    case Schema.load_collection("types", "test/fixtures") do
      {:ok, schema} ->
